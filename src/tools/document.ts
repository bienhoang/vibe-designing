...
export const mcpTools: ToolDefinition[] = [
  ...
  },
  {
    ...
    description: "Get the current page info and its top-level children. Always safe — never touches unloaded pages.",
    schema: {},
  },
  {
    name: "get_pages",
    description: "Get all pages in the document with their IDs, names, and child counts.",
    schema: {},
  },
  {
